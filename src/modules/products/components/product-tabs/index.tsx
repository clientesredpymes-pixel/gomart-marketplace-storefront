...
<span className="font-semibold">Entrega rápida</span>
              <p className="max-w-sm">
                Tu paquete llegará en 3-5 días hábiles al punto de recogida que
                elijas o directo a la comodidad de tu hogar.
              </p>
          </div>
        </div>
        <div className="flex items-start gap-x-2">
...
<span className="font-semibold">Cambios sencillos</span>
              <p className="max-w-sm">
                ¿La talla no te queda bien? No te preocupes: te cambiaremos el
...
<span className="font-semibold">Devoluciones fáciles</span>
              <p className="max-w-sm">
                ...
                Sin preguntas: haremos todo lo posible para que tu devolución
